...
Every block on those pages is generated by running the library, and CI fails if they drift
from what it actually produces. An example nobody regenerates is a claim nobody checks.
