...
> **How this was established.** live-run-partial: observed against a running agent, but not at every event this row claims -- see the matrix `observed` list for which ones were. Checked 2026-08-28.
>
